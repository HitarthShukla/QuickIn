        ...
        <div class="auth-card">
          ...
          <div class="relative z-10">
            ...
            <p class="text-center text-gray-400 mt-6">
              ...
              <RouterLink to="/login" class="text-primary-400 hover:text-primary-300 font-medium ml-1 transition-colors">
                Sign in
              </RouterLink>
            </p>
          </div>
      ...
      <div :class="['max-w-md', isLoaded ? 'animate-slide-in-right' : 'opacity-0']">
        ...
        <div class="testimonial-card">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-12 h-12 rounded-full bg-gradient-to-br from-primary-400 to-secondary-500 flex items-center justify-center font-bold text-white">
              JD
            </div>
            <div>
          ...
          <p class="text-gray-300 italic">
            "QuickIn transformed how our team collaborates. The real-time features are incredible!"
          </p>
        </div>
      </div>
    </div>
